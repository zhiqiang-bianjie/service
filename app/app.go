...
func NewSimApp(
	...
	app.mm.SetOrderBeginBlockers(
		...
		evidencetypes.ModuleName, stakingtypes.ModuleName, ibchost.ModuleName, servicetypes.ModuleName,
	)
	app.mm.SetOrderEndBlockers(crisistypes.ModuleName, govtypes.ModuleName, servicetypes.ModuleName, stakingtypes.ModuleName)
